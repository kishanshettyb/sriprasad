							...
							<Col md={4}>
								<div className="basic-card">
									...
									<div className="content">
										...
										<p>
											Målā means the impurities or negative energy or Black energy , this Målā is neither formless nor has form , there are three types , Physical , Mental and
											Emotional, there are many reasons that form or accumulate impurities some have been mentioned below , scientifically it is an exchange of energy the
											compatible energy is considered as positive energy and incompatible is negative energy but in reality there is no such positive or negative, energy it is just
											energy
										</p>
									</div>
								</div>
								...
								<div className="basic-card">
									...
									<div className="content">
										...
										<p>
											The school of Jyothishmathi - Astro/Vastu solutions is founded by Guruji Sri Prasad, a profound Srividhya Yoga Tantra Master , who is fully established in the
											Self. Our school seeks to expand the world’s understanding of yoga through an education and training that are steeped in the Shaktha tradition, the original
											roots of yoga tantra, Astrology and Vastu , a long lineage of masters while making yoga tantra, Astrology and Vastu accessible and applicable for modern day
											use for people of all ages, abilities, cultures and religions.
										</p>
									</div>
								</div>
							</Col>
